...
func (i *ImageRepository) FindByTypeAndVersion(ctx context.Context, imageType databaseconstants.ImageType, imageVersion string) (models.ImageInformation, error) {
	return gorm.G[models.ImageInformation](i.db).
